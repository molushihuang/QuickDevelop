...
public abstract class AbstractRequest implements BaseRequest {
	...
	public void request(RequestParams params, BaseResponseHandler responseHandler) {
		request(getRelativeUrl(), params, responseHandler);
	}
	 ...
	 */
	public void request(String relativeUrl, RequestParams params, final BaseResponseHandler responseHandler) {
		String url = getHost() + relativeUrl;
